            ...
            {filteredClubs.map(club => {
              ...
              return (
                ...
                >
                  ...
                  {imgs.length > 0 && (
                    <div style={{ position: 'relative', marginBottom: 18, display: 'flex', alignItems: 'center', justifyContent: 'center', height: 170 }}>
                      <button onClick={e => { e.stopPropagation(); handleCarousel(club.id, -1, imgs.length); }} style={{ position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)', background: '#FFD700', border: '2px solid #003B5C', borderRadius: '50%', width: 44, height: 44, fontSize: 24, color: '#003B5C', cursor: 'pointer', zIndex: 2, fontWeight: 900, boxShadow: '0 2px 8px rgba(0,0,0,0.10)' }}>&lt;</button>
                      <img src={imgs[idx]} alt="Club" style={{ width: '100%', height: 170, objectFit: 'cover', borderRadius: 14, border: '2px solid #FFD700', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }} />
                      <button onClick={e => { e.stopPropagation(); handleCarousel(club.id, 1, imgs.length); }} style={{ position: 'absolute', right: 0, top: '50%', transform: 'translateY(-50%)', background: '#FFD700', border: '2px solid #003B5C', borderRadius: '50%', width: 44, height: 44, fontSize: 24, color: '#003B5C', cursor: 'pointer', zIndex: 2, fontWeight: 900, boxShadow: '0 2px 8px rgba(0,0,0,0.10)' }}>&gt;</button>
                    </div>
                  )}
